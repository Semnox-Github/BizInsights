...
export const FETCH_RSA_AND_AES_ENCRIPTION = 'FETCH_CLIENT_DETAILS';
export const FETCH_RSA_AND_AES_ENCRIPTION_REQUEST = FETCH_RSA_AND_AES_ENCRIPTION + REQUEST;
export const FETCH_RSA_AND_AES_ENCRIPTION_SUCESS = FETCH_RSA_AND_AES_ENCRIPTION + SUCCESS;
export const FETCH_RSA_AND_AES_ENCRIPTION_FAILER = FETCH_RSA_AND_AES_ENCRIPTION + FAILURE;

export const SET_PUSH_NOTIFICATION_DEVICE = "SET_PUSH_NOTIFICATION_DEVICE";

export const FETCH_DEFAULT_APP_CONFIGURATION_SUCCESS =
  'FETCH_DEFAULT_APP_CONFIGURATION_SUCCESS';

export const FETCH_DEFAULT_APP_CONFIGURATION_FAILURE =
  'FETCH_DEFAULT_APP_CONFIGURATION_FAILURE';

export const FETCH_DEFAULT_APP_CONFIGURATION_REQUEST =
  'FETCH_DEFAULT_APP_CONFIGURATION_REQUEST';

//user action

//Authenticate
const AUTHENTICATE_CLIENT_DETAILS = 'AUTHENTICATE_CLIENT_DETAILS';
const SYSTEM_USER_DETAILS = 'SYSTEM_USER_DETAILS';
export const AUTHENTICATE_CLIENT_DETAILS_REQUEST =
  AUTHENTICATE_CLIENT_DETAILS + REQUEST;
export const AUTHENTICATE_CLIENT_DETAILS_SUCCESS =
  AUTHENTICATE_CLIENT_DETAILS + SUCCESS;
export const AUTHENTICATE_CLIENT_DETAILS_FAILURE =
  AUTHENTICATE_CLIENT_DETAILS + FAILURE;
export const SYSTEM_USER_DETAILS_REQUEST = SYSTEM_USER_DETAILS + REQUEST;
export const SYSTEM_USER_DETAILS_SUCCESS = SYSTEM_USER_DETAILS + SUCCESS;
export const SYSTEM_USER_DETAILS_FAILURE = SYSTEM_USER_DETAILS + FAILURE;
...
export const REGISTER_CLIENT_DETAILS_REQUEST =
  REGISTER_CLIENT_DETAILS + REQUEST;
export const REGISTER_CLIENT_DETAILS_SUCCESS =
  REGISTER_CLIENT_DETAILS + SUCCESS;
export const REGISTER_CLIENT_DETAILS_FAILURE =
  REGISTER_CLIENT_DETAILS + FAILURE;

//Authenticate
const FETCH_CLIENT_APP_DETAILS = ' FETCH_CLIENT_APP_DETAILS';
export const FETCH_CLIENT_APP_DETAILS_REQUEST =
  FETCH_CLIENT_APP_DETAILS + REQUEST;
export const FETCH_CLIENT_APP_DETAILS_SUCCESS =
  FETCH_CLIENT_APP_DETAILS + SUCCESS;
export const FETCH_CLIENT_APP_DETAILS_FAILURE =
  FETCH_CLIENT_APP_DETAILS + FAILURE;

export const FETCH_USER_ROLE = 'FETCH_USER_ROLE';

export const FETCH_USER_ROLE_REQUEST = FETCH_USER_ROLE + REQUEST;
export const FETCH_USER_ROLE_SUCCESS = FETCH_USER_ROLE + SUCCESS;
export const FETCH_USER_ROLE_FAILURE = FETCH_USER_ROLE + FAILURE;
...
export const FETCH_DASHBOARD_DETAILS_REQUEST =
  FETCH_DASHBOARD_DETAILS + REQUEST;
export const FETCH_DASHBOARD_DETAILS_SUCCESS =
  FETCH_DASHBOARD_DETAILS + SUCCESS;
export const FETCH_DASHBOARD_DETAILS_FAILURE =
  FETCH_DASHBOARD_DETAILS + FAILURE;
...
export const FETCH_APP_VALIDITY_REQUEST = 'FETCH_APP_VALIDITY_REQUEST';
